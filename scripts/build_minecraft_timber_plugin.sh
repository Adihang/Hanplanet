...
PLUGIN_DIR="$REPO_DIR/minecraft-timber-plugin"
BUILD_DIR="$PLUGIN_DIR/build"
CLASSES_DIR="$BUILD_DIR/classes"
JAR_PATH="$BUILD_DIR/HanplanetTimber.jar"
...
"$JAVAC" -encoding UTF-8 -cp "$CLASSPATH" -d "$CLASSES_DIR" \
  "$PLUGIN_DIR/src/main/java/com/hanplanet/minecraft/timber/HanplanetTimberPlugin.java"
...
cp "$JAR_PATH" "$SERVER_DIR/plugins/HanplanetTimber.jar"

echo "$SERVER_DIR/plugins/HanplanetTimber.jar"
