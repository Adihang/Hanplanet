    ...
    window.__openProjectPrintSelectorDialog = function (projectOptions, printText) {
        return new Promise(function (resolve) {
            ...
            const dialogTheme = isDarkDialog ? {
                ...
                panelBackground: readThemeToken('--site-modal-surface-bg', 'rgb(var(--site-modal-surface-rgb, 46 46 46) / var(--site-modal-surface-opacity, 0.72))'),
                panelBackdropFilter: readThemeToken('--site-modal-surface-filter', 'saturate(120%) blur(4px)'),
                panelBorderColor: 'transparent',
                panelShadow: 'var(--site-popup-shadow-common, var(--site-shadow-md, 0 12px 28px rgba(0, 0, 0, 0.28))), var(--site-modal-exterior-dim-shadow, 0 0 0 100vmax rgb(var(--site-modal-backdrop-rgb, 0 0 0) / var(--site-modal-backdrop-opacity, 0.24)))',
                titleColor: '#f1f3f7',
                ...
                overlayOpenColor: readThemeToken('--site-modal-backdrop-surface-bg', 'rgba(0, 0, 0, 0)'),
                overlayBackdropFilter: readThemeToken('--site-modal-backdrop-filter', 'none'),
                panelBackground: readThemeToken('--site-modal-surface-bg', 'rgb(var(--site-modal-surface-rgb, 248 248 248) / var(--site-modal-surface-opacity, 0.72))'),
                panelBackdropFilter: readThemeToken('--site-modal-surface-filter', 'saturate(120%) blur(4px)'),
                panelBorderColor: 'transparent',
                panelShadow: 'var(--site-popup-shadow-common, var(--site-shadow-md, 0 12px 28px rgba(0, 0, 0, 0.28))), var(--site-modal-exterior-dim-shadow, 0 0 0 100vmax rgb(var(--site-modal-backdrop-rgb, 0 0 0) / var(--site-modal-backdrop-opacity, 0.24)))',
                titleColor: '#161616',
